...
const features = ["Far-infrared wavelength (5.6-15 microns)", "360° full-body heat coverage", "Low EMF certified panels", "Medical-grade materials", "Full body immersion", "Digital temperature control"];
