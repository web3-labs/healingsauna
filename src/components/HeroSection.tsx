...
const HeroSection = () => {
  ...
  return <section id="hero" className="section-light pt-16 md:pt-32 pb-8 md:pb-24">
      <div className="container-section">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-4">Portable FAR Infrared Sauna<span className="block gradient-text">The Healing Sauna</span>
            </h1>
            ...
            <ul className="space-y-3 mb-8">
              {["Portable & foldable design", "Far-infrared full-body heat therapy", "Heats up in under 10 minutes", "Perfect for home, gym, or travel"].map((feature, index) => <li key={index} className="flex items-center gap-3 text-foreground">
          ...
          animationDelay: "0.2s"
            ...
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img src={images[selectedImage]} alt="Healing Sauna GO - Black" className="w-full h-auto rounded-xl object-cover" />
              </div>

              {/* Thumbnail Gallery */}
              <div className="flex gap-3 mt-4 justify-center">
                {images.map((img, index) => <button key={index} onClick={() => setSelectedImage(index)} className={`w-20 h-20 rounded-lg overflow-hidden border-2 transition-all shadow-md ${selectedImage === index ? "border-primary ring-2 ring-primary/20" : "border-border hover:border-primary/50"}`}>
                    <img src={img} alt="" className="w-full h-full object-cover" />
                  </button>)}
              </div>
            </div>
