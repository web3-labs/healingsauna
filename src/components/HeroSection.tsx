...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="section-dark pt-16 md:pt-32 pb-8 md:pb-24">
        ...
        <div className="lg:hidden">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="flex-shrink-0 inline-flex items-center gap-1 text-xs font-medium text-green-400 bg-green-400/10 px-2 py-1 rounded-full">
                <Check size={12} />
                In Stock
              </span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white/60 text-sm">4.9 Stars (127 Reviews)</span>
            </div>

            {/* Pricing */}
            <div className="flex items-center gap-3 flex-wrap">
              <span className="text-2xl font-bold text-white">$2,300 USD</span>
            ...
            {/* Trust Badges */}
            <div className="flex justify-center gap-6 text-white/60 text-xs pt-2">
          ...
          <div className="animate-fade-in">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex flex-col">
                <span className="text-white/50 line-through text-lg">$2,999</span>
