      ...
      <div className="container-section">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="hidden sm:block">
            <div className="text-white font-semibold text-sm">Healing Sauna GO — Black</div>
            <div className="flex items-center gap-2">
              <span className="text-white/50 line-through text-xs">$2,999</span>
              <span className="text-base font-bold gradient-text">$2,300</span>
            </div>
          </div>
          ...
          <div className="sm:hidden">
            <span className="text-base font-bold gradient-text">$2,300</span>
            <span className="text-white/50 line-through text-xs ml-2">$2,999</span>
          </div>

          {/* CTA - Shopify Buy Button */}
          <div id="sticky-shopify-button" className="min-w-[120px] scale-90" />
        </div>
      </div>
    </div>
  );
